...
|---|---|---|
| **Personal Doctor** | `/home/user/personal-doctor-python/` | Python FastAPI daily health advisor — Oura Ring, Google Drive integration, research-backed recommendations |
