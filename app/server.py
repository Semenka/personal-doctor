...
def start_server():
    ...
    logger.info("    08:05  Check-up reconcile + overdue alert")
    logger.info("    21:00  WhatsApp evening nudge (if actions still open)")
    logger.info("    Sun 18:00  Weekly retrospective email")
    logger.info("    Sun 18:15  Journal watch (weekly literature review)")
    logger.info("    Sun 18:30  Health OS brief → email + WhatsApp")
    logger.info("")
