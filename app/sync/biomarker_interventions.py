...
Citations are resolved via ``bibliography.lookup(ref_id)`` so the canonical
display string lives in one place. The bibliography is weighted toward
2015–2025 top-cited work:
 - Showell 2019 Cochrane (antioxidants for male subfertility — supersedes 2014)
 - Salas-Huetos 2017/2018/2019 (Hum Reprod Update + Andrology) for nutrition
 - Esteves 2021 (Andrology consensus on sperm DNA fragmentation)
 - Mach 2020 ESC + Ference 2017 EAS + CTT 2019 (lipids causality & targets)
 - Kronenberg 2022 EAS consensus on Lp(a)
 - Pludowski 2018 + Bouillon 2019 (vit D clinical evidence)
 - ADA 2024 + Sutton 2018 (glycemic + TRE)
 - Hajizadeh Maleki 2018 RCT (exercise + semen)
 - Hosseini 2019 RCT (omega-3 + semen)
 - Ridker 2018 CANTOS (inflammation as a CV lever beyond LDL)
...
_ANTIOX_STACK = Intervention(
    ...
    expected_effect="Improves live-birth rate (low/moderate certainty per updated Cochrane)",
    citation=_cite("showell_2019_cochrane"),
    category="supplement",
)
_COQ10 = Intervention(
    ...
    expected_effect="Improved sperm motility and density per systematic review",
    citation=_cite("salas_huetos_2018"),
    category="supplement",
)
_CARNITINE = Intervention(
    ...
    expected_effect="Motility gains in 3-6 months (updated RCT)",
    citation=_cite("mongioi_2016"),
    category="supplement",
)
_ZN_SE = Intervention(
...
_OMEGA3 = Intervention(
    ...
    expected_effect="Improved motility + morphology over 8-12 weeks (RCT)",
    citation=_cite("hosseini_2019"),
    category="supplement",
)
...
_SCROTAL_COOL = Intervention(
    ...
    citation=_cite("durairajanayagam_2014"),
    category="lifestyle",
)
_EXERCISE_MODERATE = Intervention(
    action="Moderate aerobic + resistance training 3-5×/week, 30-45 min — avoid >90 min intense sessions",
    mechanism="Improves sperm parameters; overtraining elevates cortisol and depresses them",
    expected_effect="Motility + morphology gains over 12-24 weeks (RCT in sedentary men)",
    citation=_cite("hajizadeh_maleki_2018"),
    category="movement",
)
_SLEEP_7 = Intervention(
    ...
    citation=_cite("leproult_van_cauter_2011"),
    category="sleep",
)
    ...
    "sperm_normal_morphology": {
        "low": [
            ...
            Intervention(
                ...
                citation=_cite("sermondade_2013"),
                category="nutrition",
            ),
            _SCROTAL_COOL,
            _OMEGA3,
    ...
    "sperm_dna_fragmentation": {
        "high": [
            ...
            Intervention(
                ...
                citation=_cite("wang_2019_varicocele"),
                category="medical",
            ),
        ],
    },
    ...
    "prolactin": {
        "high": [
            Intervention(
                ...
                citation=_cite("lennartsson_2015"),
                category="stress",
            ),
            Intervention(
    ...
    "ldl": {
        "high": [
            Intervention(
                ...
                citation=_cite("estruch_2018_predimed"),
                category="nutrition",
            ),
            Intervention(
                ...
                citation=_cite("brown_1999_fiber"),
                category="nutrition",
            ),
            Intervention(
    ...
    "triglycerides": {
        "high": [
            Intervention(
                ...
                citation=_cite("skulas_ray_2019_aha"),
                category="supplement",
            ),
            Intervention(
    ...
    "hemoglobin": {
        "low": [
            ...
            Intervention(
                ...
                citation=_cite("camaschella_2015"),
                category="supplement",
            ),
        ],
        "high": [
    ...
    "ferritin": {
        "low": [
            ...
            Intervention(
                ...
                citation=_cite("goddard_2011_bsg"),
                category="medical",
            ),
        ],
        "high": [
