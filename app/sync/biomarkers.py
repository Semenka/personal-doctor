...
# ── 38 markers grounded in highly-cited literature ──
# Reproductive references: WHO 2021 6th edition manual, Bungum 2007, Travison 2017, Mulhall 2018
# Energy / metabolic references: Sniderman 2019 (ApoB), Tsimikas 2017 (Lp(a)), Ridker 2003 (hs-CRP),
#   Holick 2011 (Vitamin D), Smith 2018 (homocysteine), Harris 2008 (omega-3 index)
REGISTRY: List[Biomarker] = [
    # ── 🧬 Semen analysis (WHO 2021 6th ed reference values) ──
    Biomarker(
    ...
    Biomarker(
        ...
        citations=["WHO 2021 6th ed", "Cooper 2010"],
    ...
    Biomarker(
        ...
        citations=["WHO 2021 6th ed (strict Kruger)", "Menkveld 2001"],
    ...
    Biomarker(
        ...
        citations=["Bungum 2007", "Evenson 2002"],
    ...
    Biomarker(
        ...
        citations=["Travison 2017", "Mulhall 2018", "Bhasin 2018"],
    ...
    Biomarker(
        ...
        citations=["Hyperprolactinemia guidelines 2011"],
    ...
    Biomarker(
        ...
        citations=["ADA 2024", "Tirosh 2005"],
    ...
    Biomarker(
        ...
        citations=["ADA 2024", "Selvin 2010"],
    ...
    Biomarker(
        ...
        citations=["Matthews 1985"],
        aliases=["homa-ir", "homa", "indice homa"],
        short_label="HOMA",
    ),

    # ── ❤️ Lipids (Sniderman 2019 ApoB; Tsimikas 2017 Lp(a)) ──
    Biomarker(
        ...
        citations=["Mach 2020 ESC", "Cholesterol Treatment Trialists 2010"],
    ...
    Biomarker(
        ...
        citations=["Sniderman 2019", "Mach 2020 ESC"],
    ...
    Biomarker(
        ...
        citations=["Tsimikas 2017", "Kronenberg 2022 EAS"],
    ...
    Biomarker(
        ...
        citations=["Ridker 2003", "Pearson 2003 AHA"],
    ...
    Biomarker(
        ...
        citations=["WHO iron status guidelines"],
    ...
    Biomarker(
        ...
        citations=["Whitfield 2001"],
        aliases=["ggt", "gamma-gt", "gamma gt"],
        short_label="GGT",
    ),

    # ── ☀️ Vitamins / minerals (Holick 2011 vit D, Smith 2018 homocysteine, Harris 2008 omega-3) ──
    Biomarker(
        ...
        citations=["Holick 2011 Endocrine Society", "Pilz 2011"],
    ...
    Biomarker(
        ...
        citations=["Smith 2018", "Wald 2002"],
    ...
    Biomarker(
        ...
        citations=["Colagar 2009", "Prasad 2008"],
        aliases=["zinc", "zn"],
        short_label="Zn",
    ),
    Biomarker(
        ...
        citations=["Harris 2008", "Harris 2017"],
    ...
    Biomarker(
        ...
        citations=["Wartofsky 2005", "Surks 2007"],
